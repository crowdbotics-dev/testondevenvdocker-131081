"""
Django settings for testondevenvdocker_131081 project.
...
ROOT_URLCONF = 'testondevenvdocker_131081.urls'
...
WSGI_APPLICATION = 'testondevenvdocker_131081.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testondevenvdocker_131081 API",
    "DESCRIPTION": "API documentation for testondevenvdocker_131081 App",
    "VERSION": "v1",
}
